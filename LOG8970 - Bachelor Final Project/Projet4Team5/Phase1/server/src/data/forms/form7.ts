...
export const form7 = {
  ...
  form: {
    ...
    section: {
      1: {
        1: {
          question:
            "Pour chaque énoncé ci-dessous, svp indiquez le niveau de limitation durant le dernier mois. Si une " +
            "action est complètement évitée parce que trop difficile, sélectionnez '10'. 0 signifie 'Aucune " +
            "limitation'. Si vous évitez de faire une action pour des raisons autres que la douleur ou la difficulté," +
  ...
  disclaimer:
    "Copyright Ohrbach R. Translated by Goulet J-P, Univ. Laval, Quebec, Canada. Available at " +
