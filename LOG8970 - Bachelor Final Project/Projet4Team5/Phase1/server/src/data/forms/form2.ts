      ...
      1: {
        ...
        2: {
          ...
          subquestion: {
            ...
            7: {
              question:
                "7. Au cours des 30 derniers jours, est-ce que les activités suivantes ont modifié (c’est-à-dire " +
                "amélioré ou aggravé) tout maux de tête dans la région de la tempe d’un côté ou de l’autre? ",
              subquestion: {
                1: {
                  question: "A. Mastiquer des aliments durs ou coriaces",
                  radio: ["Non", "Oui"]
