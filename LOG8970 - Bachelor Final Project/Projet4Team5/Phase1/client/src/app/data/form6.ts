...
export const form6 = {
    form: {
        ...
        section: {
            1: {
                ...
                5: {
                    question:
                        "5. Au cours des 30 DERNIERS JOURS, combien de jours votre douleur au visage vous a-t-elle empêché de faire\n" +
                        "vos ACTIVITÉS NORMALES telles que travailler, aller à l'école ou faire des travaux domestiques? (tous les\n" +
                        "jours = 30 jours)",
                    numerical: ["jours"]
                },
                6: {
                    question:
                        "6. Au cours des 30 DERNIERS JOURS, jusqu’à quel point votre douleur au visage a-t-elle interféré avec vos " +
                        "ACTIVITÉS QUOTIDIENNES. Utilisez une échelle de 0 à 10, où 0 est « aucune interférence » et 10 " +
                ...
                7: {
                    question:
                        "7. Au cours des 30 DERNIERS JOURS, jusqu’à quel point votre douleur au visage a-t-elle interféré avec VOS " +
                        "LOISIRS, VOS ACTIVITÉS SOCIALES ET FAMILIALES? Utilisez la même échelle où 0 est « aucune " +
                ...
                8: {
                    question:
                        "8. Au cours des 30 DERNIERS JOURS, jusqu’à quel point votre douleur au visage a-t-elle interféré avec VOTRE " +
                        "CAPACITÉ À TRAVAILLER, y compris les travaux domestiques? Utilisez la même échelle où 0 est « aucune " +
                        "interférence » et 10 « incapable de faire aucune activité ».",
                    slider: "8",
                    min: 0,
                    max: 10
    ...
    disclaimer:
        "Copyright Von Korff M. Translated by Goulet J-P, Univ. Laval, Quebec, Canada. Available at http://www.rdc-tmdinternational.org" +
