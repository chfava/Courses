...
export const form10 = {
            ...
            1: {
                1: {
                    ...
                    subquestion: {
                        ...
                        7: {
                            question: "7. Avoir de la difficulté à me concentrer tel qu'en lisant le journal ou en regardant la télévision",
                            radio: ["Pas du tout", "Plusieurs jours", "Plus de la moitié des jours", "Presque tous les jours"]
                        },
                        8: {
                            question:
                                "8. Bouger ou parler si lentement que les autres l'ont remarqué. Ou au contraire \
                                    – être tellement agité(e) ou hyperactif(ve) au point de bouger beaucoup plus qu'à l'habitude",
                            radio: ["Pas du tout", "Plusieurs jours", "Plus de la moitié des jours", "Presque tous les jours"]
                        },
                        9: {
    ...
    disclaimer:
        ...
        Source instrument available at http://www.phqscreeners.com/INFORMversion 12May2013. Translated by Goulet J-P, \
        Univ. Laval, Quebec, Canada.Available at http://www.rdc-tmdinternational.org"
};
