...
function generate_fdi(examResult: ExamResultInterface) {
	const pdfDoc = new HummusRecipe('./questionnaires/FDI_fr.pdf', './questionnaires/FDIrempli.pdf')
