...
model.plot()
#plt.show()
#plt.savefig('Graph_Diagnostic.svg', format='svg', dpi=1200)
#fig.savefig('Graph_Diagnostic.svg', format='svg', dpi=1200)
plt.savefig('plot_name.png', dpi = 3500)
...
def transformForFitting(line):
        return [
                ...
                None, 
                #S_MYALGIE_LOCALE
                'T' if line['MYALGIE_LOCALE'] == 1 else 'F', 
                #S_DOULEUR_MYOFASCIALE_AVEC_REF
                'T' if line['MYOFASCIALE_REF'] == 1 else 'F',
                #S_E9_PROPA_ZONE_SUB_REGION1
                line['E9_PROPA_ZONE_SUB_REGION1'],
                #S_E9_PROPA_ZONE_SUB_REGION2
                line['E9_PROPA_ZONE_SUB_REGION2'],
                ...
                None, 
                #S_DOULEUR_MYOFASCIALE
                'T' if line['MYOFASCIALE'] == 1 else 'F',
                #S_E4_HAB
                None,
                #S_E5A_HAB
                line['E5A_HAB'],
                ...
                None,
                #S_DOULEUR_MAL_TETE
                'T' if line['DOULEUR_MAL_TETE'] == 1 else 'F',
                #S_QS8, 
                line['QS8'],
                # S_E6_CRAQUE_PATIENT,
                line['E6_CRAQUE_PATIENT'],
                ...
                None,
                #S_DEPLACEMENT_DISQUE_AVEC_REDUCTION
                'T' if line['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] == 1 else 'F',
                #S_QS11,
                line['QS11'],
                #S_QS12,   
                line['QS12'],
                ...
                None,
                #S_DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE
                'T' if line['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] == 1 else 'F',
                #S_QS9,
                line['QS9'],
                #S_QS10, 
                line['QS10'],
                ...
                line['E4C_OUVER_GREATER_40'],
                #S_DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE
                'T' if line['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] == 1 else 'F',
                #S_DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE
                'T' if line['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] == 1 else 'F',
                #S_E6_CREPITE_OUVER,
                line['E6_CREPITE_OUVER'],
                #S_E6_CREPITE_FERM,
                line['E6_CREPITE_FERM'],
                ...
                None,
                #S_MALADIE_ARTICULAIRE_DEGENERATIVE
                'T' if line['MALADIE_ARTICULAIRE_DEGENERATIVE'] == 1 else 'F',
                #S_QS13,
                line['QS13'],
                #S_QS14,
                line['QS14'],
                #S_SUBLUXATION
                'T' if line['SUBLUXATION'] == 1 else 'F'
                ]

DIAGNOSTIC_LABELS = []
DIAGNOSTIC_LABELS.append('DOULEUR_MAL_TETE')
DIAGNOSTIC_LABELS.append('MYALGIE')
DIAGNOSTIC_LABELS.append('MYALGIE_LOCALE')
DIAGNOSTIC_LABELS.append('DOULEUR_MYOFASCIALE_AVEC_REF')
DIAGNOSTIC_LABELS.append('DOULEUR_MYOFASCIALE')
DIAGNOSTIC_LABELS.append('ARTHRALGIE')
DIAGNOSTIC_LABELS.append('DEPLACEMENT_DISQUE_AVEC_REDUCTION')
DIAGNOSTIC_LABELS.append('DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE')
DIAGNOSTIC_LABELS.append('DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE')
DIAGNOSTIC_LABELS.append('DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE')
DIAGNOSTIC_LABELS.append('MALADIE_ARTICULAIRE_DEGENERATIVE')
DIAGNOSTIC_LABELS.append('SUBLUXATION')
...
filename = "/Users/charles-olivierfavreau/Documents/Projet4Team5/new_data.json"
print(filename)
if filename:
...
#predictTreatment(diagnosticVector, MD1, QS5,  questions_OBC, questions_GAD, questions_PHQ9)
...
def getDiagnosticsFromVector(vector):
        labels = []
        for index, value in enumerate(vector):
                if value == 1:
                        labels.append(DIAGNOSTIC_LABELS[index])
        return labels

def visualise_Data(original_df, df, TRUE_LABELS, PREDICTED_LABLES, PROB, index):
        print("DATA: ")
        ...
        print(getDiagnosticsFromVector(TRUE_LABELS[index]))
        print('\n')

        print("PREDICTED_LABLES : ")
        print(PREDICTED_LABLES[index])
        print(PROB[index])
        print(getDiagnosticsFromVector(PREDICTED_LABLES[index]))
        print('\n')
...
Y_MASSETER_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_MASSETER_DROIT['MYALGIE'] = df['E11_MY_M_D'].apply(preprocess_N_Y_TO_1_0)
Y_MASSETER_DROIT['MYALGIE_LOCALE'] = 0
Y_MASSETER_DROIT['MYOFASCIALE_REF'] = df['E11_MYO_M_D'].apply(preprocess_N_Y_TO_1_0)
Y_MASSETER_DROIT['MYOFASCIALE'] = 0
Y_MASSETER_DROIT['ARTHRALGIE'] = 0

Y_MASSETER_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_MASSETER_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_MASSETER_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_MASSETER_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_MASSETER_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_MASSETER_DROIT['SUBLUXATION'] = 0
#Y_MASSETER_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)


#oneLine = df_MASSETER_DROIT.iloc[0].to_dict()


Y_MASSETER_DROIT_TRUE_LABEL = []
for i in range(0,df_MASSETER_DROIT.shape[0]):
        Y_MASSETER_DROIT_TRUE_LABEL.append(Y_MASSETER_DROIT.iloc[i].values.tolist())

df_MASSETER_DROIT_TRANSFORMED_ = pd.concat([df_MASSETER_DROIT, Y_MASSETER_DROIT], axis=1, sort=False)

DATA_MASSETER_DROIT_FOR_FITTING = []
for i in range(0,df_MASSETER_DROIT_TRANSFORMED_.shape[0]):
        DATA_MASSETER_DROIT_FOR_FITTING.append(transformForFitting(df_MASSETER_DROIT_TRANSFORMED_.iloc[i].to_dict()))


#print(DATA_MASSETER_DROIT_FOR_FITTING)
print('Start fitting')
model = model.fit(DATA_MASSETER_DROIT_FOR_FITTING, verbose = True, n_jobs = -1)

print('end fitting')
#print(accuracy_score(Y_MASSETER_DROIT_TRUE_LABEL, Y_MASSETER_DROIT_predicted))

#print(np.sum(np.not_equal(Y_MASSETER_DROIT.values, np.array(Y_MASSETER_DROIT_TRUE_LABEL)))/float(Y_MASSETER_DROIT.values.size))
...
print('Exact Match ratio Accuracy MASSETER_DROIT: ')
print(np.all(np.array(Y_MASSETER_DROIT_predicted) == np.array(Y_MASSETER_DROIT_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_MASSETER_DROIT_predicted), np.array(Y_MASSETER_DROIT_TRUE_LABEL)))
...
Y_MASSETER_GAUCHE = pd.DataFrame()
Y_MASSETER_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_MASSETER_GAUCHE['MYALGIE'] = df['E11_MY_M_G'].apply(preprocess_N_Y_TO_1_0)
Y_MASSETER_GAUCHE['MYALGIE_LOCALE'] = 0
Y_MASSETER_GAUCHE['MYOFASCIALE_REF'] = df['E11_MYO_M_G'].apply(preprocess_N_Y_TO_1_0)
Y_MASSETER_GAUCHE['MYOFASCIALE'] = 0
Y_MASSETER_GAUCHE['ARTHRALGIE'] = 0

Y_MASSETER_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_MASSETER_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_MASSETER_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_MASSETER_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_MASSETER_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_MASSETER_GAUCHE['SUBLUXATION'] = 0
#Y_MASSETER_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)



Y_MASSETER_GAUCHE_TRUE_LABEL = []
for i in range(0,df_MASSETER_GAUCHE.shape[0]):
        Y_MASSETER_GAUCHE_TRUE_LABEL.append(Y_MASSETER_GAUCHE.iloc[i].values.tolist())

df_MASSETER_GAUCHE_TRANSFORMED_ = pd.concat([df_MASSETER_GAUCHE, Y_MASSETER_GAUCHE], axis=1, sort=False)

DATA_MASSETER_GAUCHE_FOR_FITTING = []
for i in range(0,df_MASSETER_GAUCHE_TRANSFORMED_.shape[0]):
        DATA_MASSETER_GAUCHE_FOR_FITTING.append(transformForFitting(df_MASSETER_GAUCHE_TRANSFORMED_.iloc[i].to_dict()))


#print(DATA_MASSETER_GAUCHE_FOR_FITTING)
print('Start fitting')
model = model.fit(DATA_MASSETER_GAUCHE_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
...
print('Exact Match ratio Accuracy MASSETER_GAUCHE: ')
print(np.all(np.array(Y_MASSETER_GAUCHE_predicted) == np.array(Y_MASSETER_GAUCHE_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_MASSETER_GAUCHE_predicted), np.array(Y_MASSETER_GAUCHE_TRUE_LABEL)))
...
Y_TEMPORAL_DROIT = pd.DataFrame()
Y_TEMPORAL_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_TEMPORAL_DROIT['MYALGIE'] = df['E11_MY_T_D'].apply(preprocess_N_Y_TO_1_0)
Y_TEMPORAL_DROIT['MYALGIE_LOCALE'] = 0
Y_TEMPORAL_DROIT['MYOFASCIALE_REF'] = df['E11_MYO_T_D'].apply(preprocess_N_Y_TO_1_0)
Y_TEMPORAL_DROIT['MYOFASCIALE'] = 0
Y_TEMPORAL_DROIT['ARTHRALGIE'] = 0

Y_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_TEMPORAL_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_TEMPORAL_DROIT['SUBLUXATION'] = 0
#Y_TEMPORAL_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)




Y_TEMPORAL_DROIT_TRUE_LABEL = []
for i in range(0,df_TEMPORAL_DROIT.shape[0]):
        Y_TEMPORAL_DROIT_TRUE_LABEL.append(Y_TEMPORAL_DROIT.iloc[i].values.tolist())

#############################
df_TEMPORAL_DROIT_TRANSFORMED_ = pd.concat([df_TEMPORAL_DROIT, Y_TEMPORAL_DROIT], axis=1, sort=False)

DATA_TEMPORAL_DROIT_FOR_FITTING = []
for i in range(0,df_TEMPORAL_DROIT_TRANSFORMED_.shape[0]):
        DATA_TEMPORAL_DROIT_FOR_FITTING.append(transformForFitting(df_TEMPORAL_DROIT_TRANSFORMED_.iloc[i].to_dict()))


#print(DATA_TEMPORAL_DROIT_FOR_FITTING)
print('Start fitting')
model = model.fit(DATA_TEMPORAL_DROIT_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy TEMPORAL_DROIT_predicted: ')
print(np.all(np.array(Y_TEMPORAL_DROIT_predicted) == np.array(Y_TEMPORAL_DROIT_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_TEMPORAL_DROIT_predicted), np.array(Y_TEMPORAL_DROIT_TRUE_LABEL)))
...
Y_TEMPORAL_GAUCHE = pd.DataFrame()
Y_TEMPORAL_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_TEMPORAL_GAUCHE['MYALGIE'] = df['E11_MY_T_G'].apply(preprocess_N_Y_TO_1_0)
Y_TEMPORAL_GAUCHE['MYALGIE_LOCALE'] = 0
Y_TEMPORAL_GAUCHE['MYOFASCIALE_REF'] = df['E11_MYO_T_G'].apply(preprocess_N_Y_TO_1_0)
Y_TEMPORAL_GAUCHE['MYOFASCIALE'] = 0
Y_TEMPORAL_GAUCHE['ARTHRALGIE'] = 0

Y_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_TEMPORAL_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_TEMPORAL_GAUCHE['SUBLUXATION'] = 0
#Y_TEMPORAL_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)



Y_TEMPORAL_GAUCHE_TRUE_LABEL = []
for i in range(0,df_TEMPORAL_GAUCHE.shape[0]):
        Y_TEMPORAL_GAUCHE_TRUE_LABEL.append(Y_TEMPORAL_GAUCHE.iloc[i].values.tolist())

#############################
df_TEMPORAL_GAUCHE_TRANSFORMED_ = pd.concat([df_TEMPORAL_GAUCHE, Y_TEMPORAL_GAUCHE], axis=1, sort=False)

DATA_TEMPORAL_GAUCHE_FOR_FITTING = []
for i in range(0,df_TEMPORAL_GAUCHE_TRANSFORMED_.shape[0]):
        DATA_TEMPORAL_GAUCHE_FOR_FITTING.append(transformForFitting(df_TEMPORAL_GAUCHE_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_TEMPORAL_GAUCHE_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_TEMPORAL_GAUCHE: ')
print(np.all(np.array(Y_TEMPORAL_GAUCHE_predicted) == np.array(Y_TEMPORAL_GAUCHE_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_TEMPORAL_GAUCHE_predicted), np.array(Y_TEMPORAL_GAUCHE_TRUE_LABEL)))
...
Y_PTERIGOIDIEN_DROIT = pd.DataFrame()
Y_PTERIGOIDIEN_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_PTERIGOIDIEN_DROIT['MYALGIE'] = df['E11_MY_P_D'].apply(preprocess_N_Y_TO_1_0)
Y_PTERIGOIDIEN_DROIT['MYALGIE_LOCALE'] = 0
##E11_MYO_M_D need to be changed with value is E11_MYO_P_D in DB
Y_PTERIGOIDIEN_DROIT['MYOFASCIALE_REF'] = df['E11_MYO_M_D'].apply(preprocess_N_Y_TO_1_0)
##
Y_PTERIGOIDIEN_DROIT['MYOFASCIALE'] = 0
Y_PTERIGOIDIEN_DROIT['ARTHRALGIE'] = 0

Y_PTERIGOIDIEN_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_PTERIGOIDIEN_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_PTERIGOIDIEN_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_PTERIGOIDIEN_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_PTERIGOIDIEN_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_PTERIGOIDIEN_DROIT['SUBLUXATION'] = 0
#Y_PTERIGOIDIEN_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)




Y_PTERIGOIDIEN_DROIT_TRUE_LABEL = []
for i in range(0,df_PTERIGOIDIEN_DROIT.shape[0]):
        Y_PTERIGOIDIEN_DROIT_TRUE_LABEL.append(Y_PTERIGOIDIEN_DROIT.iloc[i].values.tolist())

#############################
df_PTERIGOIDIEN_DROIT_TRANSFORMED_ = pd.concat([df_PTERIGOIDIEN_DROIT, Y_PTERIGOIDIEN_DROIT], axis=1, sort=False)

DATA_PTERIGOIDIEN_DROIT_FOR_FITTING = []
for i in range(0,df_PTERIGOIDIEN_DROIT_TRANSFORMED_.shape[0]):
        DATA_PTERIGOIDIEN_DROIT_FOR_FITTING.append(transformForFitting(df_PTERIGOIDIEN_DROIT_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_PTERIGOIDIEN_DROIT_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_PTERIGOIDIEN_DROIT: ')
print(np.all(np.array(Y_PTERIGOIDIEN_DROIT_predicted) == np.array(Y_PTERIGOIDIEN_DROIT_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_PTERIGOIDIEN_DROIT_predicted), np.array(Y_PTERIGOIDIEN_DROIT_TRUE_LABEL)))
...
Y_PTERIGOIDIEN_GAUCHE= pd.DataFrame()
Y_PTERIGOIDIEN_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_PTERIGOIDIEN_GAUCHE['MYALGIE'] = df['E11_MY_P_G'].apply(preprocess_N_Y_TO_1_0)
Y_PTERIGOIDIEN_GAUCHE['MYALGIE_LOCALE'] = 0
##E11_MYO_M_D need to be changed with value is E11_MYO_P_D in DB
Y_PTERIGOIDIEN_GAUCHE['MYOFASCIALE_REF'] = df['E11_MYO_M_G'].apply(preprocess_N_Y_TO_1_0)
##
Y_PTERIGOIDIEN_GAUCHE['MYOFASCIALE'] = 0
Y_PTERIGOIDIEN_GAUCHE['ARTHRALGIE'] = 0

Y_PTERIGOIDIEN_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_PTERIGOIDIEN_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_PTERIGOIDIEN_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_PTERIGOIDIEN_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_PTERIGOIDIEN_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_PTERIGOIDIEN_GAUCHE['SUBLUXATION'] = 0
#Y_PTERIGOIDIEN_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)



Y_PTERIGOIDIEN_GAUCHE_TRUE_LABEL = []
for i in range(0,df_PTERIGOIDIEN_GAUCHE.shape[0]):
        Y_PTERIGOIDIEN_GAUCHE_TRUE_LABEL.append(Y_PTERIGOIDIEN_GAUCHE.iloc[i].values.tolist())

#############################
df_PTERIGOIDIEN_GAUCHE_TRANSFORMED_ = pd.concat([df_PTERIGOIDIEN_GAUCHE, Y_PTERIGOIDIEN_GAUCHE], axis=1, sort=False)

DATA_PTERIGOIDIEN_GAUCHE_FOR_FITTING = []
for i in range(0,df_PTERIGOIDIEN_GAUCHE_TRANSFORMED_.shape[0]):
        DATA_PTERIGOIDIEN_GAUCHE_FOR_FITTING.append(transformForFitting(df_PTERIGOIDIEN_GAUCHE_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_PTERIGOIDIEN_GAUCHE_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_PTERIGOIDIEN_GAUCHE: ')
print(np.all(np.array(Y_PTERIGOIDIEN_GAUCHE_predicted) == np.array(Y_PTERIGOIDIEN_GAUCHE_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_PTERIGOIDIEN_GAUCHE_predicted), np.array(Y_PTERIGOIDIEN_GAUCHE_TRUE_LABEL)))
...
Y_DIGASTRIQUE_DROIT= pd.DataFrame()
Y_DIGASTRIQUE_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_DIGASTRIQUE_DROIT['MYALGIE'] = df['E11_MY_D_D'].apply(preprocess_N_Y_TO_1_0)
Y_DIGASTRIQUE_DROIT['MYALGIE_LOCALE'] = 0
Y_DIGASTRIQUE_DROIT['MYOFASCIALE_REF'] = df['E11_MYO_D_D'].apply(preprocess_N_Y_TO_1_0)
Y_DIGASTRIQUE_DROIT['MYOFASCIALE'] = 0
Y_DIGASTRIQUE_DROIT['ARTHRALGIE'] = 0

Y_DIGASTRIQUE_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_DIGASTRIQUE_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_DIGASTRIQUE_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_DIGASTRIQUE_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_DIGASTRIQUE_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_DIGASTRIQUE_DROIT['SUBLUXATION'] = 0
#Y_DIGASTRIQUE_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)



Y_DIGASTRIQUE_DROIT_TRUE_LABEL = []
for i in range(0,df_DIGASTRIQUE_DROIT.shape[0]):
        Y_DIGASTRIQUE_DROIT_TRUE_LABEL.append(Y_DIGASTRIQUE_DROIT.iloc[i].values.tolist())

#############################
df_DIGASTRIQUE_DROIT_TRANSFORMED_ = pd.concat([df_DIGASTRIQUE_DROIT, Y_DIGASTRIQUE_DROIT], axis=1, sort=False)

DATA_DIGASTRIQUE_DROIT_FOR_FITTING = []
for i in range(0,df_DIGASTRIQUE_DROIT_TRANSFORMED_.shape[0]):
        DATA_DIGASTRIQUE_DROIT_FOR_FITTING.append(transformForFitting(df_DIGASTRIQUE_DROIT_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_DIGASTRIQUE_DROIT_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_DIGASTRIQUE_DROIT: ')
print(np.all(np.array(Y_DIGASTRIQUE_DROIT_predicted) == np.array(Y_DIGASTRIQUE_DROIT_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_DIGASTRIQUE_DROIT_predicted), np.array(Y_DIGASTRIQUE_DROIT_TRUE_LABEL)))
...
Y_DIGASTRIQUE_GAUCHE= pd.DataFrame()
Y_DIGASTRIQUE_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_DIGASTRIQUE_GAUCHE['MYALGIE'] = df['E11_MY_D_G'].apply(preprocess_N_Y_TO_1_0)
Y_DIGASTRIQUE_GAUCHE['MYALGIE_LOCALE'] = 0
Y_DIGASTRIQUE_GAUCHE['MYOFASCIALE_REF'] = df['E11_MYO_D_G'].apply(preprocess_N_Y_TO_1_0)
Y_DIGASTRIQUE_GAUCHE['MYOFASCIALE'] = 0
Y_DIGASTRIQUE_GAUCHE['ARTHRALGIE'] = 0

Y_DIGASTRIQUE_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_DIGASTRIQUE_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_DIGASTRIQUE_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_DIGASTRIQUE_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_DIGASTRIQUE_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_DIGASTRIQUE_GAUCHE['SUBLUXATION'] = 0
#Y_DIGASTRIQUE_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)



Y_DIGASTRIQUE_GAUCHE_TRUE_LABEL = []
for i in range(0,df_DIGASTRIQUE_GAUCHE.shape[0]):
        Y_DIGASTRIQUE_GAUCHE_TRUE_LABEL.append(Y_DIGASTRIQUE_GAUCHE.iloc[i].values.tolist())

#############################
df_DIGASTRIQUE_GAUCHE_TRANSFORMED_ = pd.concat([df_DIGASTRIQUE_GAUCHE, Y_DIGASTRIQUE_GAUCHE], axis=1, sort=False)

DATA_DIGASTRIQUE_GAUCHE_FOR_FITTING = []
for i in range(0,df_DIGASTRIQUE_GAUCHE_TRANSFORMED_.shape[0]):
        DATA_DIGASTRIQUE_GAUCHE_FOR_FITTING.append(transformForFitting(df_DIGASTRIQUE_GAUCHE_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_DIGASTRIQUE_GAUCHE_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_DIGASTRIQUE_GAUCHE: ')
print(np.all(np.array(Y_DIGASTRIQUE_GAUCHE_predicted) == np.array(Y_DIGASTRIQUE_GAUCHE_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_DIGASTRIQUE_GAUCHE_predicted), np.array(Y_DIGASTRIQUE_GAUCHE_TRUE_LABEL)))
...
'''
Y_SOUS_MANDIBULAIRE_DROIT= pd.DataFrame()
Y_SOUS_MANDIBULAIRE_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_SOUS_MANDIBULAIRE_DROIT['MYALGIE'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_SOUS_MANDIBULAIRE_DROIT['MYALGIE_LOCALE'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['MYOFASCIALE_REF'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_SOUS_MANDIBULAIRE_DROIT['MYOFASCIALE'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['ARTHRALGIE'] = 0

Y_SOUS_MANDIBULAIRE_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_SOUS_MANDIBULAIRE_DROIT['SUBLUXATION'] = 0
#Y_SOUS_MANDIBULAIRE_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)
...
Y_SOUS_MANDIBULAIRE_DROIT_TRUE_LABEL = []
for i in range(0,df_SOUS_MANDIBULAIRE_DROIT.shape[0]):
        Y_SOUS_MANDIBULAIRE_DROIT_TRUE_LABEL.append(Y_SOUS_MANDIBULAIRE_DROIT.iloc[i].values.tolist())


for i in range(0,df_SOUS_MANDIBULAIRE_DROIT.shape[0]):
        print(Y_SOUS_MANDIBULAIRE_DROIT_predicted[i])
        print(Y_SOUS_MANDIBULAIRE_DROIT_TRUE_LABEL[i])
        print("\n")


print(1 - hamming_loss(np.array(Y_SOUS_MANDIBULAIRE_DROIT_predicted), np.array(Y_SOUS_MANDIBULAIRE_DROIT_TRUE_LABEL)))
...
'''
Y_SOUS_MANDIBULAIRE_GAUCHE= pd.DataFrame()
Y_SOUS_MANDIBULAIRE_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_SOUS_MANDIBULAIRE_GAUCHE['MYALGIE'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_SOUS_MANDIBULAIRE_GAUCHE['MYALGIE_LOCALE'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['MYOFASCIALE_REF'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_SOUS_MANDIBULAIRE_GAUCHE['MYOFASCIALE'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['ARTHRALGIE'] = 0

Y_SOUS_MANDIBULAIRE_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_SOUS_MANDIBULAIRE_GAUCHE['SUBLUXATION'] = 0
#Y_SOUS_MANDIBULAIRE_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)
...
Y_SOUS_MANDIBULAIRE_GAUCHE_TRUE_LABEL = []
for i in range(0,df_SOUS_MANDIBULAIRE_GAUCHE.shape[0]):
        Y_SOUS_MANDIBULAIRE_GAUCHE_TRUE_LABEL.append(Y_SOUS_MANDIBULAIRE_GAUCHE.iloc[i].values.tolist())


for i in range(0,df_SOUS_MANDIBULAIRE_GAUCHE.shape[0]):
        print(Y_SOUS_MANDIBULAIRE_GAUCHE_predicted[i])
        print(Y_SOUS_MANDIBULAIRE_GAUCHE_TRUE_LABEL[i])
        print("\n")


print(1 - hamming_loss(np.array(Y_SOUS_MANDIBULAIRE_GAUCHE_predicted), np.array(Y_SOUS_MANDIBULAIRE_GAUCHE_TRUE_LABEL)))
...
'''
Y_TENDON_TEMPORAL_DROIT= pd.DataFrame()
Y_TENDON_TEMPORAL_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_TENDON_TEMPORAL_DROIT['MYALGIE'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_TENDON_TEMPORAL_DROIT['MYALGIE_LOCALE'] = 0
Y_TENDON_TEMPORAL_DROIT['MYOFASCIALE_REF'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_TENDON_TEMPORAL_DROIT['MYOFASCIALE'] = 0
Y_TENDON_TEMPORAL_DROIT['ARTHRALGIE'] = 0
Y_TENDON_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_TENDON_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_TENDON_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_TENDON_TEMPORAL_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_TENDON_TEMPORAL_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_TENDON_TEMPORAL_DROIT['SUBLUXATION'] = 0
#Y_TENDON_TEMPORAL_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)
...
Y_TENDON_TEMPORAL_DROIT_TRUE_LABEL = []
for i in range(0,df_TENDON_TEMPORAL_DROIT.shape[0]):
        Y_TENDON_TEMPORAL_DROIT_TRUE_LABEL.append(Y_TENDON_TEMPORAL_DROIT.iloc[i].values.tolist())


for i in range(0,df_TENDON_TEMPORAL_DROIT.shape[0]):
        print(Y_TENDON_TEMPORAL_DROIT_predicted[i])
        print(Y_TENDON_TEMPORAL_DROIT_TRUE_LABEL[i])
        print("\n")


print(1 - hamming_loss(np.array(Y_TENDON_TEMPORAL_DROIT_predicted), np.array(Y_TENDON_TEMPORAL_DROIT_TRUE_LABEL)))
...
'''
Y_TENDON_TEMPORAL_GAUCHE= pd.DataFrame()
Y_TENDON_TEMPORAL_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_TENDON_TEMPORAL_GAUCHE['MYALGIE'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_TENDON_TEMPORAL_GAUCHE['MYALGIE_LOCALE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['MYOFASCIALE_REF'] = df[''].apply(preprocess_N_Y_TO_1_0)
Y_TENDON_TEMPORAL_GAUCHE['MYOFASCIALE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['ARTHRALGIE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = 0
Y_TENDON_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = 0
Y_TENDON_TEMPORAL_GAUCHE['SUBLUXATION'] = 0
#Y_TENDON_TEMPORAL_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)
...
Y_TENDON_TEMPORAL_GAUCHE_TRUE_LABEL = []
for i in range(0,df_TENDON_TEMPORAL_GAUCHE.shape[0]):
        Y_TENDON_TEMPORAL_GAUCHE_TRUE_LABEL.append(Y_TENDON_TEMPORAL_GAUCHE.iloc[i].values.tolist())


for i in range(0,df_TENDON_TEMPORAL_GAUCHE.shape[0]):
        print(Y_TENDON_TEMPORAL_GAUCHE_predicted[i])
        print(Y_TENDON_TEMPORAL_GAUCHE_TRUE_LABEL[i])
        print("\n")


print(1 - hamming_loss(np.array(Y_TENDON_TEMPORAL_GAUCHE_predicted), np.array(Y_TENDON_TEMPORAL_GAUCHE_TRUE_LABEL)))
...
Y_ATM_DROIT= pd.DataFrame()

Y_ATM_DROIT['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_ATM_DROIT['MYALGIE'] = int(0)
Y_ATM_DROIT['MYALGIE_LOCALE'] = int(0)
Y_ATM_DROIT['MYOFASCIALE_REF'] = int(0)
Y_ATM_DROIT['MYOFASCIALE'] = int(0)
Y_ATM_DROIT['ARTHRALGIE'] = df['E11_AD'].apply(preprocess_N_Y_TO_1_0)
Y_ATM_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = df['E11_ATMD'].apply(preprocess_DISORDER_ATM_DEP_REDUC)
Y_ATM_DROIT['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = df['E11_ATMD'].apply(preprocess_DISORDER_ATM_DEP_REDUC_BLOC)
Y_ATM_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = df['E11_ATMD'].apply(preprocess_DISORDER_ATM_S_REDUC_ET_OUV_LIM)
Y_ATM_DROIT['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = df['E11_ATMD'].apply(preprocess_DISORDER_ATM_S_REDUC_S_OUV)
Y_ATM_DROIT['MALADIE_ARTICULAIRE_DEGENERATIVE'] = df['E11_ATMD'].apply(preprocess_DISORDER_ATM_MDA)
Y_ATM_DROIT['SUBLUXATION'] = df['E11_ATMD'].apply(preprocess_DISORDER_ATM_SUB)
#Y_ATM_DROIT['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)




Y_ATM_DROIT_TRUE_LABEL = []
for i in range(0,df_ATM_DROIT.shape[0]):
        Y_ATM_DROIT_TRUE_LABEL.append(Y_ATM_DROIT.iloc[i].values.tolist())

#############################
df_ATM_DROIT_TRANSFORMED_ = pd.concat([df_ATM_DROIT, Y_ATM_DROIT], axis=1, sort=False)

DATA_ATM_DROIT_FOR_FITTING = []
for i in range(0,df_ATM_DROIT_TRANSFORMED_.shape[0]):
        DATA_ATM_DROIT_FOR_FITTING.append(transformForFitting(df_ATM_DROIT_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_ATM_DROIT_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_ATM_DROIT: ')
print(np.all(np.array(Y_ATM_DROIT_predicted) == np.array(Y_ATM_DROIT_TRUE_LABEL), axis=1).mean())

#visualise_Data(df, df_ATM_DROIT, Y_ATM_DROIT_TRUE_LABEL, Y_ATM_DROIT_predicted, 129)

for index in range(0, len(Y_ATM_DROIT_TRUE_LABEL)):
        print(index)
        visualise_Data(df, df_ATM_DROIT, Y_ATM_DROIT_TRUE_LABEL, Y_ATM_DROIT_predicted, Y_ATM_DROIT_PROBA, index)


print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_ATM_DROIT_predicted), np.array(Y_ATM_DROIT_TRUE_LABEL)))
...
Y_ATM_GAUCHE= pd.DataFrame()
Y_ATM_GAUCHE['DOULEUR_MAL_TETE'] = df['E11_MTAD'].apply(preprocess_N_Y_TO_1_0)
Y_ATM_GAUCHE['MYALGIE'] = int(0)
Y_ATM_GAUCHE['MYALGIE_LOCALE'] = int(0)
Y_ATM_GAUCHE['MYOFASCIALE_REF'] = int(0)
Y_ATM_GAUCHE['MYOFASCIALE'] = int(0)
Y_ATM_GAUCHE['ARTHRALGIE'] = df['E11_AG'].apply(preprocess_N_Y_TO_1_0)
Y_ATM_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION'] = df['E11_ATMG'].apply(preprocess_DISORDER_ATM_DEP_REDUC)
Y_ATM_GAUCHE['DEPLACEMENT_DISQUE_AVEC_REDUCTION_ET_BLOCAGE'] = df['E11_ATMG'].apply(preprocess_DISORDER_ATM_DEP_REDUC_BLOC)
Y_ATM_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_AVEC_OUVER_LIMITE'] = df['E11_ATMG'].apply(preprocess_DISORDER_ATM_S_REDUC_ET_OUV_LIM)
Y_ATM_GAUCHE['DEPLACEMENT_DISQUE_SANS_REDUCTION_SANS_OUVER_LIMITE'] = df['E11_ATMG'].apply(preprocess_DISORDER_ATM_S_REDUC_S_OUV)
Y_ATM_GAUCHE['MALADIE_ARTICULAIRE_DEGENERATIVE'] = df['E11_ATMG'].apply(preprocess_DISORDER_ATM_MDA)
Y_ATM_GAUCHE['SUBLUXATION'] = df['E11_ATMG'].apply(preprocess_DISORDER_ATM_SUB)
#Y_ATM_GAUCHE['NO_DISORDER'] = df['E11_NO'].apply(preprocess_N_Y_TO_1_0)


Y_ATM_GAUCHE_TRUE_LABEL = []
for i in range(0,df_ATM_GAUCHE.shape[0]):
        Y_ATM_GAUCHE_TRUE_LABEL.append(Y_ATM_GAUCHE.iloc[i].values.tolist())

#############################
df_ATM_GAUCHE_TRANSFORMED_ = pd.concat([df_ATM_GAUCHE, Y_ATM_GAUCHE], axis=1, sort=False)

DATA_ATM_GAUCHE_FOR_FITTING = []
for i in range(0,df_ATM_GAUCHE_TRANSFORMED_.shape[0]):
        DATA_ATM_GAUCHE_FOR_FITTING.append(transformForFitting(df_ATM_GAUCHE_TRANSFORMED_.iloc[i].to_dict()))


print('Start fitting')
model = model.fit(DATA_ATM_GAUCHE_FOR_FITTING, verbose = True, n_jobs = -1)
print('end fitting')
############################
...
print('Exact Match ratio Accuracy Y_ATM_GAUCHE: ')
print(np.all(np.array(Y_ATM_GAUCHE_predicted) == np.array(Y_ATM_GAUCHE_TRUE_LABEL), axis=1).mean())

print("Hamming Loss Accuracy")
print(1 - hamming_loss(np.array(Y_ATM_GAUCHE_predicted), np.array(Y_ATM_GAUCHE_TRUE_LABEL)))

print("Accuracy Final : ")

##concatenate all dataframes to see all variables in one line

frames = [df_TEMPORAL_DROIT, df_TEMPORAL_GAUCHE, 
        df_MASSETER_DROIT, df_MASSETER_GAUCHE, 
        df_ATM_DROIT, df_ATM_GAUCHE, 
        df_DIGASTRIQUE_DROIT,df_DIGASTRIQUE_GAUCHE,
         df_PTERIGOIDIEN_DROIT, df_PTERIGOIDIEN_GAUCHE] 
DF = pd.concat(frames, axis=1, sort=False).drop_duplicates().reset_index(drop=True)



Y_TRUE_LABEL = []
Y_predicted = []
for i in range(0, len(Y_TEMPORAL_DROIT_TRUE_LABEL)):
        line_TRUE_LABEL = []
        line_TRUE_LABEL += Y_TEMPORAL_DROIT_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_TEMPORAL_GAUCHE_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_MASSETER_DROIT_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_MASSETER_GAUCHE_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_ATM_DROIT_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_ATM_GAUCHE_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_DIGASTRIQUE_DROIT_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_DIGASTRIQUE_GAUCHE_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_PTERIGOIDIEN_DROIT_TRUE_LABEL[i]
        line_TRUE_LABEL += Y_PTERIGOIDIEN_GAUCHE_TRUE_LABEL[i]
        Y_TRUE_LABEL.append(line_TRUE_LABEL)
        #print(line_TRUE_LABEL)
...
#print("TREATMENT_predicted :")
#print(TREATMENT_predicted)


print('Exact Match ratio Accuracy : ')
print(np.all(np.array(Y_predicted) == np.array(Y_TRUE_LABEL), axis=1).mean())

print('Hamming Loss Accuracy : ')
total = 0
for i in range(0, len(Y_predicted)):
       total +=  (1 - ((hamming_loss(np.array(Y_predicted[i]), np.array(Y_TRUE_LABEL[i])))))
print(total / len(Y_predicted))

print('Jaccard Score Accuracy : ')
totalJaccard = 0
for i in range(0, len(Y_predicted)):
        totalJaccard += (jaccard_similarity_score(np.array(Y_TRUE_LABEL[i]), np.array(Y_predicted[i])))
print(totalJaccard / len(Y_predicted))

print('F1 Score Accuracy : ')
totalF1 = 0
for i in range(0, len(Y_predicted)):
        totalF1 += f1_score(np.array(Y_TRUE_LABEL[i]), np.array(Y_predicted[i]), average='micro')
print(totalF1 / len(Y_predicted))
...
'''
for i in range(0, len(Y_TRUE_LABEL)):
        visualise_Data(DF, Y_TRUE_LABEL, Y_predicted, i)
        print("##########################################################################################################")
'''
...
for i in range(0, len(Y_predicted)):
        m.update_state(Y_predicted[i], Y_TRUE_LABEL[i])
...
print(cosine_similarity([np.array(Y_predicted[0])], [np.array(Y_TRUE_LABEL[0])]))
'''
'''
from numpy import dot
from numpy.linalg import norm

a = np.array(Y_predicted[0])
b = np.array(Y_TRUE_LABEL[0])
