(function () {
  ...
  */
  ...
  function update() {
    ...
    let circleNumbers = d3.selectAll("circle")
                          .size();
    console.log(circleNumbers);
    d3.select("#circles-count")
      .text(circleNumbers);
  ...
  function createCircles() {
    ...
    */
   const circleNumbers = d3.select("#quantity").node().value;
   console.log(circleNumbers);
  ...
  function textTip(radius, position, color) {
     ...
     */
    return "Radius: " + radius  + "<br>Position: " + position + "<br>Color: " + color;
  ...
  var tip = d3.tip()
    ...
    .html(function () {
      ...
      var radius = parseFloat(d3.select(this).attr("r")).toFixed(2);
      var position = "(" + parseFloat(d3.select(this).attr("cx")).toFixed(2) 
                    + ", " + parseFloat(d3.select(this).attr("cx")).toFixed(2) 
                    + ")";
